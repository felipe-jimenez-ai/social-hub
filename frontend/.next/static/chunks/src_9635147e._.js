...
"[project]/src/utils/create-test-users.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseServiceKey);
async function createTestUsers() {
    ...
    for (const user of testUsers){
        try {
            ...
            if (authError) {
                console.error("Error creating user ".concat(user.email, ":"), authError);
                results.push({
                    email: user.email,
                    success: false,
            ...
            if (!authData.user) {
                console.error("No user data returned for ".concat(user.email));
                results.push({
                    email: user.email,
                    success: false,
            ...
            if (profileError) {
                console.error("Error creating profile for ".concat(user.email, ":"), profileError);
                results.push({
                    email: user.email,
                    success: false,
            ...
            console.log("Successfully created user and profile for ".concat(user.email));
            results.push({
                email: user.email,
                success: true,
            ...
            console.error("Unexpected error for ".concat(user.email, ":"), error);
            results.push({
                email: user.email,
                success: false,
...
"[project]/src/app/(protected)/admin/create-test-users/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$create$2d$test$2d$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/create-test-users.ts [app-client] (ecmascript)");
;
...
function CreateTestUsersPage() {
    ...
    const handleCreateUsers = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$create$2d$test$2d$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTestUsers"])();
            // Restore console.log
...
_s(CreateTestUsersPage, "KhEoWm7ZxyCR4qn+1yeP7inusTM=");
_c = CreateTestUsersPage;
var _c;
__turbopack_context__.k.register(_c, "CreateTestUsersPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_9635147e._.js.map