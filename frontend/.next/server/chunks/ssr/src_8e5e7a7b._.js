...
"[project]/src/app/(protected)/my-circle/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            connections.filter((connection)=>{
                                ...
                                return (profile.display_name?.toLowerCase() || '').includes(search) || (profile.title?.toLowerCase() || '').includes(search) || (profile.superpower?.toLowerCase() || '').includes(search) || (profile.ask?.toLowerCase() || '').includes(search) || (connection.notes?.toLowerCase() || '').includes(search);
                            }).map((connection)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ConnectionCard, {
...
function ConnectionCard({ connection, onDelete, onUpdateNotes }) {
    ...
    const [notesValue, setNotesValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(connection.notes || '');
...
//# sourceMappingURL=src_8e5e7a7b._.js.map